...
# as required by the Claude Code PreToolUse hook stdout contract.
...
# Runtime is always claude_code for this hook
RUNTIME="claude_code"
...
# Emit hookSpecificOutput envelope as required by Claude Code PreToolUse stdout contract
jq -n \
