...
class TestEscapedAdvisorySnapshotSerialization:
    """Issue #2056 unit coverage; this never creates a disposable Issue."""

    def test_given_backslash_control_like_advisory_when_rendered_then_yaml_quoting_is_safe(self) -> None:
        fingerprint = {
            "issue_number": 2056,
            "contract_source_kind": "issue_comment",
        ...
        comment = _ecs_mod._build_contract_review_comment(
            issue_number=2056,
            repo=_REPO,
            review_result={
                "checks": {
            ...
            body_sha256=fingerprint["contract_body_sha256"],
            expected_contract_fingerprint=fingerprint,
        )

        assert "      classifications: '" in comment
        assert "  expected_contract_fingerprint: '" in comment
