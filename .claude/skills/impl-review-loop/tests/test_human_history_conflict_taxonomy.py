...
_spec = importlib.util.spec_from_file_location(
    "human_history_conflict", _ROOT / ".claude/skills/issue-refinement-loop/scripts/publish_termination_report.py"
)
...
def test_only_repeated_same_iteration_conflict_becomes_human_escalation_history():
    base = {
        "loop_kind": "impl-review-loop", "phase": "conflict-resolution",
    ...
    assert "conflict_hard_stop" in policy or "conflict_hard_stop" in (_ROOT / ".claude/skills/impl-review-loop/steps/step-5-feedback-and-termination.md").read_text()
