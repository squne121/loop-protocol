...
REPO_EVIDENCE_REF_V1:
  ...
  properties:
    commit_sha:
      type: string
      pattern: "^[a-f0-9]{40}$"
      description: "40-character SHA-1 commit hash. Identifies exact commit at which excerpt was verified. Mutable branch references (blob/main, tree/develop) are forbidden."
