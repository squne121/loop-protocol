...
control-plane / data-plane の分離・LOOP_STATE 設計・ループ内の人間承認原則・各 SubAgent 役割は `docs/dev/agent-skill-boundaries.md` の「オーケストレーター設計原則」セクションを正本とする。本 skill は作業手順に専念する。
