...
`hard_stop_eligible == true` (i.e., phase is `review`, `post_rewrite_check`, or
`decide_next_action`), the loop stops with `human_escalation`. See
`references/scope-signal-guard.md` for signal taxonomy and phase-gate rules.
