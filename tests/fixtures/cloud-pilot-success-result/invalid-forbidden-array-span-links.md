...
この fixture は禁止フィールド span_links の配列混入を検証するための負例であり、checker が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=c6bbc87e9a0acefd654c3cf9815e44d6fb4d8b79f91c4987de24b523f874b93b -->
