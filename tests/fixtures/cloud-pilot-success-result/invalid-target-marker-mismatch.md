...
この fixture は payload.target.marker_value の形式不正を検証するための負例であり、schema validation が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=486778fed43a775baf7689a6fd0e2c125f18c50d66f016d856ca2767aebdec07 -->
