...
この fixture はネストされた禁止フィールド（exception.stacktrace）混入を検証するための負例であり、checker が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=42f69130fd5af1c1a9739efd3b9133b42107c6f0a9ea8d230f5b106b981c7f13 -->
