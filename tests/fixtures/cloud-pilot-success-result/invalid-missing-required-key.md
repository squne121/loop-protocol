...
この fixture は必須キー（safety）欠落を検証するための負例であり、checker が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=b7a2c80c058f8fd0580ed9013f35e82515d9b63176a03c61b77f985ae8bd4d36 -->
