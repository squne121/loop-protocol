...
この fixture は digest 計算入力にマーカー文字列自体が混入した場合の不正を検証するための負例であり、checker が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=fc556d2504a2bbd250eaa6a189925d3a0c28023ea1085b8aac6aae8a0bafa4ee -->
