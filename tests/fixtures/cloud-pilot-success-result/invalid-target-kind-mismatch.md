...
この fixture は outer マーカーの target と payload.target の kind 不一致を検証するための負例であり、checker が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=47a8df85215563394741843e9927b9f41bf7faf8fd7dca05b390524cee73bd58 -->
