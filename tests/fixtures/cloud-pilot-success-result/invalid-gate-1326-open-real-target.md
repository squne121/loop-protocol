...
この fixture は #1326 が open のまま real target として提示された不正を検証するための負例であり、checker が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=f6791e297d79569dd9c579cf7ebe0e56171b3ae9c77e4a4b61447cc0d2826cd3 -->
