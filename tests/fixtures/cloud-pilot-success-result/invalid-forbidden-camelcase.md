...
この fixture は禁止フィールドの camelCase 変種（traceState）混入を検証するための負例であり、checker が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=3bf8552e443da2ee5fe614ef9dfd67617029a192fa469ef85ba3f9fa2a1f311e -->
