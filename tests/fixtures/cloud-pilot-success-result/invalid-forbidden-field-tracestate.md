...
この fixture は禁止フィールド tracestate の混入を検証するための負例であり、checker が拒否することを確認するためのものである。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=b9c0ce42b6fe8e29c8067897e21fcccaf00b25226acc2e02d7e8f0e718a560d1 -->
