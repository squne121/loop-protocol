...
この fixture は outer marker の result_id と payload.result_id が食い違う負例であり、checker が拒否することを確認するためのものである（OWNER Blocker 3, fix_delta iteration 2）。以下のマーカー行はチェッカーが参照する契約でありバイト単位で変更しない。
...
```json
{
  ...
  "result_id": "cloud-pilot-success-result-fixture-only-baseline-x",
  "parent_issue": "#1153",
  "contract_issue": "#1260",
...
この digest 値はこの fixture の内容（result_id mismatch を含む）から正しく再計算された fresh digest である。
<!-- CLOUD_PILOT_SUCCESS_RESULT_DIGEST_V1 sha256=340d67fa6986d34357dc07269d841d3458b7c66eb243f23dbfac2206893a4983 -->
