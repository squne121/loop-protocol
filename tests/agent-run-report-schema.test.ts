...
describe('agent_run_report schema compile', () => {
  ...
  for (const fixtureName of [
    ...
    'invalid-public-observation-source-available-with-source-unavailable.json',
    'invalid-public-observation-source-supported-with-partial-projection.json',
    'invalid-public-observation-source-unsupported-with-partial-projection.json',
