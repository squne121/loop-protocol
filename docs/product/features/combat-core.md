...
## Combat Numeric Display Policy (Issue #581)

SSOT identifiers: `number_display_policy`, `formatCombatNumber` (see `src/render/renderUtils.ts`).
...
|---|---|---|
| 0 to 9999 | exact | "0", "999", "9999" |
| 10000 to 999999 | floor(value / 1000) + "k" | "10k", "999k" |
| 1000000+ | floor(value / 1000000) + "M" | "1M" |

Floor rounding is used to avoid displaying HP as larger than actual.
