...
| 確率論的プロンプト | AI 向け実行コンテキスト | ルート / per-directory `CLAUDE.md`, `.agents/skills/`（Codex custom agent の repo-local skill surface）, `.claude/skills/`（Claude prompt surface）, `.claude/agents/` |
